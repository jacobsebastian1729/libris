...
import { CommentType, BookType } from '../../types/type';
    ...
    return <div>
      ...
      <Grid container spacing={0} p={0}>
          <Grid
            ...
            display= 'flex'
          >
            <Avatar sx={{ bgcolor: deepOrange[500], mt: 0.8, mr:2, ml: 0.8 }}>OP</Avatar>
            <TextField id="filled-basic" label="Add a comment..." variant="filled" onChange={handleCommentChange} style={{width: '80%'}}/>

            <IconButton size="large" aria-label="show 4 new mails"  sx={{ color: "white", backgroundColor: 'pink', m: .5}} onClick={postComment}>
